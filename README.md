# DEEPFACE Face Recognition - Attack & Defense System

This project implements a comprehensive face recognition attack and defense system using the DEEPFACE model.
...
```bash
# Build Docker image
docker build -t nudt_deepface:latest .
```
...
**Solution**: Check input directory structure and file extensions (.jpg, .png)

### Issue: Model weights not loading
**Solution**: Ensure weights file exists in `input/model/` directory
...
```bibtex
@software{nudt_deepface_2024,
  title = {DEEPFACE Face Recognition Attack & Defense System},
  author = {NUDT Research Team},
  year = {2024},
  url = {https://github.com/your-repo/nudt_deepface}
}
```
...
- DEEPFACE authors for the face recognition model
- Research community for attack and defense methodologies
...
### v1.0.0 (2024-11-16)
- Initial release
- Support for 6 attack methods
- Support for 5 defense methods
...
- [ ] Add more attack methods (FGSM, MI-FGSM, etc.)
